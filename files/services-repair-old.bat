...
sc config HfcDisableService start= demand
sc config AESMService start= demand
...
sc config MicrosoftEdgeElevationService1d85091153fe8ca start= demand
...
sc config NvTelemetryContainer start= demand
...
sc config SUService start= demand
...
sc config WTabletServiceISD start= demand
